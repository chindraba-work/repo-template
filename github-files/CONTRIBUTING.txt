...
in a manner verifiable by GitHub. Again, the git command makes this simple with
...
you use for creating the commits. GitHub has a good page, "Generating a new GPG
key" (see below), which explains, and guides you through the process of creating
one. That page also helps you associate the new PGP key with your account on
GitHub, if you wish. I would recommend that where the instructions suggest
...
One extra step that is required beyond the GitHub help example is that your key
...
create a Pull request on GitHub (see link below).
...
<https://github.com/<<GITHUB_USER>>/<<GITHUB_REPO>>/issues>

    New Pull Requests on GitHub
<https://github.com/<<GITHUB_USER>>/<<GITHUB_REPO>>/pulls>
